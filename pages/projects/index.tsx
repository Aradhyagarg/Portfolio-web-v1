                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  <h3>
                    <a
                      ...
                      href="https://visora-eight.vercel.app/"
                      target="_blank"
                      rel="noreferrer"
                      aria-label="Apex4u"
                    >
                  ...
                  <p className="mt-2 text-sm leading-normal text-justify">
                    ...
                    (10 usage limit) and premium tiers with secure payment integration.
                    Developed community feature with real time like/unlike functionality serving 100+ concurrent users.
                  </p>
                </div>
                <img
                  alt=""
                  ...
                  src={"/images/projects/Visora.png"}
                />
              </div>
            </li>
            <li className="mb-12">
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  ...
                  <p className="mt-2 text-sm leading-normal text-justify">
                    ...
                    Mailtrap for effective email testing and communication with users.
                    Creating RESTful APIs, integrating MongoDB and designing using chakra-ui.
                  </p>
                </div>
                <img
                  alt=""
                  ...
                  className="rounded transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                  style={{ color: "transparent" }}
                  src={"/images/projects/flixcourses.png"}
                />
              </div>
            </li>
            <li className="mb-12">
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <img
                  ...
                  style={{ color: "transparent" }}
                  src={"/images/projects/cyberville.png"}
                />
              </div>
            </li>
            <li className="mb-12">
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <img
                  ...
                  className="rounded transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                  style={{ color: "transparent" }}
                  src={"/images/projects/PictoVerse.png"}
                />
              </div>
            </li>
          </ul>
