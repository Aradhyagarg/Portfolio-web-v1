        ...
        <div className="w-full flex flex-wrap">
          <div className="w-1/2 p-2">
            <Image
              ...
              src="/certificates/oops-java.png"
              width={150}
              height={200}
              alt="HackerRank C# Basic Certificate"
              onClick={() =>
                handleOpenModal("/certificates/oops-java.png")
              }
            />
          </div>
          <div className="w-1/2 p-2">
            <Image
              className="w-full h-auto transition-transform duration-300 transform hover:scale-110 cursor-pointer"
              src="/certificates/advance-web.png"
              width={150}
              height={200}
              alt="Foundational C sharp Certificate(Microsoft)"
              onClick={() =>
                handleOpenModal("/certificates/advance-web.png")
              }
            />
          </div>
          <div className="w-1/2 p-2">
            <Image
              className="w-full h-auto transition-transform duration-300 transform hover:scale-110 cursor-pointer"
              src="/certificates/Git & Github Learning.png"
              width={150}
              height={200}
              alt="HackerRank JavaScript Basic Certificate"
              onClick={() =>
                handleOpenModal(
                  "/certificates/Git & Github Learning.png"
                )
              }
            />
          </div>
          <div className="w-1/2 p-2">
            <Image
              className="w-full h-auto transition-transform duration-300 transform hover:scale-110 cursor-pointer"
              src="/certificates/agile.png"
              width={150}
              height={200}
              alt="HackerRank SQL Basic Certificate"
              onClick={() =>
                handleOpenModal("/certificates/agile.png")
              }
            />
          </div>
          <div className="w-1/2 p-2">
            <Image
              className="w-full h-auto transition-transform duration-300 transform hover:scale-110 cursor-pointer"
              src="/certificates/intro-web.png"
              width={150}
              height={200}
              alt="FreeCodeCampg JavaScript Algorithms and Data Structure"
              onClick={() =>
                handleOpenModal("/certificates/intro-web.png")
              }
            />
          </div>
          <div className="w-1/2 p-2">
            <Image
              className="w-full h-auto transition-transform duration-300 transform hover:scale-110 cursor-pointer"
              src="/certificates/coderscave.png"
              width={150}
              height={200}
              alt="Udemy AWS Course Completion Certificate"
              onClick={() =>
                handleOpenModal("/certificates/coderscave.png")
              }
            />
          </div>
        </div>
