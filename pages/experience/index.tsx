        ...
        <div>
              ...
              <div className="group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:col-span-6">
                  ...
                  <div className="mt-2 text-sm leading-normal text-justify">
                    ...
                    Developed importers for XML and multi-document features, ensuring seamless file export with data when moving files to user-defined data types.
                    Crafted unit test cases using NUnit and mocking to ensure comprehensive coverage of the implemented feature.
          ...
          <div className="mt-12">
            <a
              ...
              href="/resume/Aradhya_Resume.pdf"
              target="_blank"
            >
              <span>
